export const dashboardSummary = [
  ...
  { label: "Open Tasks", value: "48", trend: "8 due this week" },
  { label: "Team Utilization", value: "84%", trend: "+5% vs last sprint" },
  { label: "On-Time Delivery", value: "93%", trend: "Above PRD goal of 90%" },
];
...
export const recentActivities = [
  "Roadmap milestone M3 marked complete",
  "Design specs uploaded for onboarding flow",
  "QA raised 3 issues in checkout module",
